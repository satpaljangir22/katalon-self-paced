...
WebUI.setText(findTestObject('Object Repository/Page_Selenium Grid Online  Run Selenium Tes_77a03b/input_Name_title'), 'demo form')
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Selenium Grid Online  Run Selenium Tes_77a03b/div_Ajax Request is Processing'), 
    0)
